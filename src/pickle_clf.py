...
TfidfVectorizer = TfidfVectorizer(use_idf=True, strip_accents='ascii',
                                  tokenizer=None, )
...
print(roc_auc_score(y_test, logr_clf.predict_proba(X_test)[:, 1]))  # test our model's accuracy
print('---------------------------------------------')
...
print(roc_auc_score(y_test, sgd_clf.predict_proba(X_test)[:, 1]))  # test our model's accuracy
print('---------------------------------------------')
...
print(roc_auc_score(y_test, mnb_clf.predict_proba(X_test)[:, 1]))  # test our model's accuracy
print('---------------------------------------------')

bnb_clf = BernoulliNB()
bnb_clf.fit(X_train, y_train)
print('The accuracy of BernoulliNB with TfidfVectorizer is:')
print(roc_auc_score(y_test, bnb_clf.predict_proba(X_test)[:, 1]))  # test our model's accuracy
print('---------------------------------------------')
